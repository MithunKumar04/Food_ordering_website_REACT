...
function AddItem() {
  ...
  {
    if (name === "") {toast.error("Restaurant Name is required.", toastOptions);return false;}
  else if (itname === "") {toast.error("Dish Name is required.", toastOptions);return false;}
  else if (price === 0) {toast.error("Price of Dish is required.", toastOptions);return false;}
  else if (ratings === 0) {toast.error("Ratings is required.", toastOptions);return false;}
  else if (desc === "") {toast.error("Description for the Dish is required.", toastOptions);return false;}
  return true;
  }  const BackButton=()=>
  {
    navigate(0);
